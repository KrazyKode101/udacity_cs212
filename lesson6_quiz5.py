...
# User Instructions
# 
# The find_prefixes function takes a hand, a prefix, and a results list as input. 
# Modify the find_prefixes function to cache previous results in order to improve performance.
import os,sys
